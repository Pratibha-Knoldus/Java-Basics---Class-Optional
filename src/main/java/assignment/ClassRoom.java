...
public class ClassRoom {
    ...
    /**
     * Method Find the students associated with a room that have no subjects associated.
    ...
    /**
     * Method To Find the unique subject list of the students associated with a room that has given roomID.
     * @param classRoomId
